...
describe('UserHelpers', () => {
  const fullName = "Luffy,Monkey";
  it('should return first name from the given name', () => {
    expect(userHelpers.getFirstNameFromFullName(fullName)).toBe('Luffy');
  });

  it('should return last name from the given name', () => {
    expect(userHelpers.getLastNameFromFullName(fullName)).toBe('Monkey');
  });
});
